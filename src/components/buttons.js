  ...
  return (
    <Tag
      ...
      className={`flex items-center justify-center space-x-3 transition-all duration-300 px-2 w-full font-medium py-3 ${
        disabled ? 'cursor-not-allowed bg-emerald-800' : 'bg-emerald-600'
      } text-white text-sm rounded-md focus:outline-none hover:bg-emerald-700 focus:ring focus:border-emerald-500 focus:ring-emerald-500/50`}
    >
      {children}
    </Tag>
  )
    ...
    case 'secondary':
      return (
        <button
          ...
          } px-6 ${sizeClass} text-sm text-emerald-400 transition duration-300 border rounded shadow-xl focus:outline-none hover:shadow-none`}
          onClick={url === null ? onClick : gotoLink}
        >
          {children}
        </button>
        ...
        <button
          ...
          className={`${className} flex items-center justify-center space-x-2 ${
            disabled
              ...
              : 'bg-white hover:text-white hover:bg-emerald-400'
          } px-6 ${sizeClass} text-sm text-emerald-400 transition duration-300 border border-emerald-400 rounded shadow-xl focus:outline-none hover:shadow-none`}
          onClick={url === null ? onClick : gotoLink}
        >
          {children}
        </button>
